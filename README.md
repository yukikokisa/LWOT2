...
<p align="center">
  ...
  <a href="https://railsguides.jp/getting_started.html"><img src="https://user-images.githubusercontent.com/70472160/107140863-7e374a00-6968-11eb-8b82-2082e2e1a60e.png" height="70px;" /></a>
</p>
...
## 工夫したポイント
「要件定義」と「UI設計」です。<br>
このアプリは特別な機能を実装したわけでも、デザインをこだわったわけでもありません。<br>
ただ、看護師の業務負担を軽減するという要件定義に大半の時間を費やしました。<br>
徹底した点は、できるだけシンプルな画面構造にしたことです。<br>
理由は、パソコン操作が苦手でも、時間がなく忙しかったとしても、<br>
どこに何があるのか、ひと目で把握できるようにしたかったからです。<br>
また、業務負担の軽減に重点を置いたアプリのため、患者さんに操作説明を求められたときでも、<br>
短い時間で伝えやすくしたいという思いもありました。<br>
このアプリでは、看護業務の推定30分以上を節約できると考えています。<br>
厚労省が発表している看護師の残業時間は月平均16時間であり、<br>
これを1500人規模の看護師が在中する医療機関で換算すると、年間3060万円の残業代を削減することができます。<br>
ユーザーを意識し、利益を追求することを考えられたこともエンジニアとして大切なポイントだと学びました。<br>
